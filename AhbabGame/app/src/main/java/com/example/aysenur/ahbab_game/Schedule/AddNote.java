...
import com.example.aysenur.ahbab_game.reminder.AlarmSchedule;
...
public class AddNote extends AppCompatActivity {
            ...
            btnAddNote.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(edtAddNote.getText().length() > 0){
                        ...
                        Intent intent = new Intent(AddNote.this, ScheduleActivity.class);
    ...
    private void addSchedule() throws ParseException {
        ...
        DatabaseReference mFirebaseDatabase = mFirebaseInstance.getReference("schedule").child(userID);
    ...
    private void updateSchedule(final Schedule updateSchedule) throws ParseException {
        ...
        btnAddNote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(edtAddNote.getText().length() > 0 ){
                    DatabaseReference dR = FirebaseDatabase.getInstance().getReference("schedule").child(userID).child(updateSchedule.getId());
