...
public class Level4Activity extends AppCompatActivity {
    ...
    private void checkEnd(){
        if(iv_11.getVisibility() == View.INVISIBLE &&
            ...
            Move move = new Move(date_move, "4", playerPoints, timer-5);

            mFirebaseDatabase.child(moveId).setValue(move);

            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Level4Activity.this);
            alertDialogBuilder
    ...
    private void frontOfCardsResources(){
        image101 = R.drawable.ic_image1013;
        image102 = R.drawable.ic_image1014;
        image103 = R.drawable.ic_image1015;
        image104 = R.drawable.ic_image1016;
        image105 = R.drawable.ic_image1017;
        image106 = R.drawable.ic_image1018;
        image201 = R.drawable.ic_image2013;
        image202 = R.drawable.ic_image2014;
        image203 = R.drawable.ic_image2015;
        image204 = R.drawable.ic_image2016;
        image205 = R.drawable.ic_image2017;
        image206 = R.drawable.ic_image2018;
    }
}
